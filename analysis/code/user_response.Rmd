...
```{r echo=FALSE}
ggsave(file="participant_group_rating_differences_confidence.png", plot=participant_group_difference_plots_intervals$plot_confidence, path = "../plots/comparisons/user_response", width = 7, height = 7)
