...
Next, we want to see if there is any significant difference in accuracy between the two search algorithms (bfs and dfs), the two oracles (dzbian and compassql), and the participant groups (student and professional).
...
``` {r}
search_differences <- expected_diff_in_mean_plot(predictive_data, "search", "Expected Difference in Mean Accuracy (p_correct)",  "Task", "dataset")
...
``` {r}
oracle_differences <- expected_diff_in_mean_plot(predictive_data, "oracle", "Expected Difference in Mean Accuracy (p_correct)",  "Task", "dataset")
...
``` {r}
participant_group_differences <- expected_diff_in_mean_plot(predictive_data, "participant_group", "Expected Difference in Mean Accuracy (p_correct)", "Task", "dataset")
