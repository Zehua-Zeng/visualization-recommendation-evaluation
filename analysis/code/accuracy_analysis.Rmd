...
draw_plot <- posterior_draws_plot(plot_data, "Dataset", TRUE, "Predicted Average Accuracy (p_correct)", "Oracle/Search Combination") + scale_alpha(guide = 'none') +  coord_cartesian(xlim = c(0.4, 1))
draw_plot
```
