...
Seconds.  We choose to work in log space in order to prevent our model from predicting completion times of less than zero seconds. 

```{r}
model <- brm(
    formula = bf(
    completion_time ~ oracle * search + dataset + task + (1 | participant_id)
  ),
...
```{r}
diff_in_search_plot_and_intervals <- expected_diff_in_mean_plot(predictive_data, "search", "Expected Time Difference (Seconds)",  "Task", FALSE, NULL)

ggsave(file="search_time_differences.png", plot=diff_in_search_plot_and_intervals$plot, path = "../plots/comparisons/time", width = 7, height = 7)

diff_in_search_plot_and_intervals$plot

```

We can double-check the boundaries of the credible intervals to be sure whether or not the interval contains zero.
```{r}
write.csv(diff_in_search_plot_and_intervals$intervals, "../plot_data/comparisons/time/search_time_differences.csv", sep="", row.names = FALSE)

diff_in_search_plot_and_intervals$intervals
```

Let's do the above, but split it by datasets
```{r}
diff_in_search_plot_and_intervals_split_by_dataset <- expected_diff_in_mean_plot(predictive_data, "search", "Expected Time Difference (Seconds)",  "Task", FALSE, "dataset")

ggsave(file="split_by_dataset_search_time_differences.png", plot=diff_in_search_plot_and_intervals_split_by_dataset$plot, path = "../plots/comparisons/time", width = 7, height = 7)

diff_in_search_plot_and_intervals_split_by_dataset$plot
```


Check intervals
```{r}
write.csv(diff_in_search_plot_and_intervals_split_by_dataset$intervals, "../plot_data/comparisons/time/search_time_differences_split_by_dataset.csv", row.names = FALSE)

diff_in_search_plot_and_intervals_split_by_dataset$intervals
...
diff_in_oracle_plot_and_intervals <- expected_diff_in_mean_plot(predictive_data, "oracle", "Expected Time Difference (Seconds)",  "Task", FALSE, NULL)

ggsave(file="oracle_time_differences.png", plot=diff_in_oracle_plot_and_intervals$plot, path = "../plots/comparisons/time", width = 7, height = 7)

diff_in_oracle_plot_and_intervals$plot
...
We can double-check the boundaries of the credible intervals to be sure whether or not the interval contains zero.
```{r}
write.csv(diff_in_oracle_plot_and_intervals$intervals, "../plot_data/comparisons/time/oracle_time_differences.csv", sep="", row.names = FALSE)

diff_in_oracle_plot_and_intervals$intervals
```

Let's do the above, but split it by datasets
```{r}
diff_in_oracle_plot_and_intervals_subset_split_by_dataset <- expected_diff_in_mean_plot(predictive_data, "oracle", "Expected Time Difference (Seconds)",  "Task", FALSE, "dataset")
ggsave(file="split_by_dataset_oracle_time_differences.png", plot=diff_in_oracle_plot_and_intervals_subset_split_by_dataset$plot, path = "../plots/comparisons/time", width = 7, height = 7)

diff_in_oracle_plot_and_intervals_subset_split_by_dataset$plot
```
...
Check intervals
```{r}
write.csv(diff_in_oracle_plot_and_intervals_subset_split_by_dataset$intervals, "../plot_data/comparisons/time/oracle_time_differences_split_by_dataset.csv", row.names = FALSE)

diff_in_oracle_plot_and_intervals_subset_split_by_dataset$intervals
...
diff_in_search_plot_and_intervals_subset <- expected_diff_in_mean_plot(predictive_data_subset, "search", "Expected Time Difference (Seconds)",  "Task", TRUE, NULL)

ggsave(file="search_time_differences_subset.png", plot=diff_in_search_plot_and_intervals_subset$plot, path = "../plots/comparisons/time", width = 7, height = 7)

diff_in_search_plot_and_intervals_subset$plot
```

```{r}
diff_in_search_prediction_split_by_dataset_subset <- expected_diff_in_mean_plot(predictive_data_subset, "search", "Expected Time Difference (Seconds)",  "Task", FALSE, "dataset")
...
```{r}
diff_in_oracle_plot_and_intervals_subset <- expected_diff_in_mean_plot(predictive_data_subset, "oracle", "Expected Time Difference (Seconds)",  "Task", FALSE, NULL)

ggsave(file="oracle_time_differences_subset.png", plot=diff_in_oracle_plot_and_intervals_subset$plot, path = "../plots/comparisons/time", width = 7, height = 7)

diff_in_oracle_plot_and_intervals_subset$plot
```
```{r}
diff_in_oracle_plot_and_intervals_subset_split_by_dataset_subset <- expected_diff_in_mean_plot(predictive_data_subset, "oracle", "Expected Time Difference (Seconds)",  "Task", FALSE, "dataset")
ggsave(file="split_by_dataset_oracle_time_differences_subset.png", plot=diff_in_oracle_plot_and_intervals_subset_split_by_dataset_subset$plot, path = "../plots/comparisons/time", width = 7, height = 7)

diff_in_oracle_plot_and_intervals_subset_split_by_dataset_subset$plot
```
