...
run_model_time(subset(time_data, task == "3. Prediction"), "Prediction", 522.32, 394.61)
run_model_time(subset(time_data, task == "4. Exploration"), "Exploration", 415.88, 115.98)
