...
#         row = [participant_id, participant_group, dataset, oracle, search, task, num_interacted_variable_set]
...
#         row = [participant_id, participant_group, dataset, oracle, search, task, num_interacted_visual_design]
#         jsons_data.loc[index] = row

# jsons_data.to_csv('num_of_interacted_visual_design.csv', index=False)
...
#         row = [participant_id, participant_group, dataset, oracle, search, task, num_exposed_variable_set]
#         jsons_data.loc[index] = row
...
for index, js in enumerate(json_files):
    with open(os.path.join(path_to_json, js)) as json_file:
        ...
        row = [participant_id, participant_group, dataset, oracle, search, task, num_exposed_visual_design]
        jsons_data.loc[index] = row

jsons_data.to_csv('num_of_exposed_visual_design.csv', index=False)